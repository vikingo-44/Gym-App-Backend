...
// 🚨 CRÍTICO: Añadido 'Save' para el botón de notas
...
    // 🚨 NUEVOS ESTILOS PARA NOTAS DEL ALUMNO
    notesContainer: {
        width: '100%',
...
// ----------------------------------------------------------------------
// COMPONENTE: Panel de Notas del Alumno (AÑADIDO)
// ----------------------------------------------------------------------
        ...
        <View style={assignmentStyles.notesContainer}>
            ...
            >
                <Text style={assignmentStyles.notesTitle}>
                    📝 Notas del Alumno {isNotesPanelExpanded ? ' (Cerrar)' : ' (Abrir)'}
                </Text>
            ...
            {isNotesPanelExpanded && (
                <View style={{ paddingTop: 10 }}>
                    ...
                    <TextInput
                        ...
                        placeholder="Escribe aquí notas sobre el progreso, lesiones o metas del alumno..."
...
    
    // ----------------------------------------------------------------
    // 🚨 FUNCION: CARGAR NOTAS DEL ALUMNO (AÑADIDO)
    // ----------------------------------------------------------------
...
    // ----------------------------------------------------------------
    // 🚨 FUNCION: GUARDAR/ACTUALIZAR NOTAS DEL ALUMNO (AÑADIDO)
    // ----------------------------------------------------------------
...
    useEffect(() => {
        fetchCurrentAssignments();
        fetchStudentNotes(); // 🚨 CARGAR NOTAS
...
                </View>
                
                {/* -------------------- 0. PANEL DE NOTAS DEL ALUMNO (AÑADIDO) -------------------- */}
                <StudentNotesPanel 
